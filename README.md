...
- can append a compact adaptive workflow-state block to scheduled prompts, or use a step-plan controller that advances one repeating cron only after the agent reports the active step complete
